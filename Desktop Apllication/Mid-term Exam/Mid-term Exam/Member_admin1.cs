...
{
    public partial class Member_admin1 : Form
    {
        public Member_admin1()
        {
            InitializeComponent();
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("Select * from Member_details ", conn);
        ...
        {
            Books_per_user Form4 = new Books_per_user();
            Form4.Show();
            this.Hide();
        }
